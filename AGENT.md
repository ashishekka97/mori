...
* **No UI in Engine:** The `:engine` module is isolated at the compiler level. Do NOT suggest Jetpack Compose, ViewModels, or XML layouts inside this module.
...
* **No Network Calls for Persona:** All health, battery, and usage data must be gathered locally inside `:persona`. Do not suggest REST APIs for user data.
