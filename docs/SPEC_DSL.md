...
*   **Layer Count:** Maximum **64 layers** per biome. Any layers defined beyond this limit in the JSON will be ignored by the Engine.
...
The Golden Rule of 64: Stay within the 64-layer limit to guarantee 60fps and low battery impact across all Android devices.
