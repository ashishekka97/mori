...
### 5.1 Foundations
- [ ] **5.1.1 Typography:** Define the `PulseTypography` system (High-legibility atmospheric type).
...
- [ ] **5.2.1 Glassmorphic Container:** Build `MoriCard` with custom blur/AGSL shaders.
