...
### 1.1 WorldState & Hub
- [ ] **1.1.1 WorldState Schema:** Define the flat-categorized data class with primitive types.
- [ ] **1.1.2 StateManager Interface:** Define the contract for the central state hub.
...
- [ ] **1.2.2 Provider Registry:** Implement `StateProviderRegistry` to aggregate multiple sensors.
